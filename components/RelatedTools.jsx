...
const tools = [
  ...
  { key: 'jwt-decoder', name: 'JWT Decoder', href: '/jwt-decoder', description: 'Decode, verify HS256, and sign JWTs' },
  { key: 'chmod-calculator', name: 'chmod Calculator', href: '/chmod-calculator', description: 'Unix file permissions — 755, 644, and more' },
  { key: 'http-status-codes', name: 'HTTP Status Codes', href: '/http-status-codes', description: 'Searchable 200, 404, 429, 502 reference' },
  { key: 'env-file-validator', name: 'ENV File Validator', href: '/env-file-validator', description: 'Validate .env, find dupes, export JSON' },
  { key: 'semver-calculator', name: 'Semver Calculator', href: '/semver-calculator', description: 'Check if a version matches ^ / ~ ranges' },
...
const relatedMap = {
  ...
  'number-base-converter': ['hash-generator', 'chmod-calculator', 'uuid-generator', 'cron-generator'],
  ...
  'hash-generator': ['uuid-generator', 'password-generator', 'chmod-calculator', 'base64-encoder'],
  ...
  'jwt-decoder': ['base64-encoder', 'json-formatter', 'hash-generator', 'timestamp-converter'],
  'chmod-calculator': ['number-base-converter', 'http-status-codes', 'hash-generator', 'cron-generator'],
  'http-status-codes': ['jwt-decoder', 'url-encoder', 'json-formatter', 'env-file-validator'],
  'env-file-validator': ['json-formatter', 'yaml-json-converter', 'semver-calculator', 'base64-encoder'],
  'semver-calculator': ['env-file-validator', 'uuid-generator', 'hash-generator', 'json-formatter'],
  'timestamp-converter': ['cron-generator', 'uuid-generator', 'jwt-decoder', 'chmod-calculator'],
